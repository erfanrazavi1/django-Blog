...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for name in category_list:
            Category.objects.get_or_create(name=name) # get_or_create will not create duplicate categories
        ...
        for _ in range(10):
            post = Post.objects.create(
                ...
                status=True,
                category=Category.objects.get(name=self.fake.random_element(elements=category_list)),
            )
