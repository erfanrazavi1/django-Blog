...
class TestUserApi:
    ...
    def test_login_user_wrong_password_response_status_400(
        self, login_data, registration_data
    ):
        """
    ...
    def test_register_user_with_mismatched_passwords_response_status_400(
        ...
        registration_data["confirm_password"] = (
            "wrongpassword"  # real password is "hasaniii1234"
        )
        response = self.client.post(url, registration_data)
        assert response.status_code == 400
